...
lCPI0_0:
	...
	.quad	131275                          ; 0x200cb
	.section	__TEXT,__text,regular,pure_instructions
	.globl	__Z26setup_performance_countersv
	.p2align	2
__Z26setup_performance_countersv:       ; @_Z26setup_performance_countersv
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #96                     ; =96
...
Lloh1:
	...
	mov	w1, #1
	bl	_dlopen
	adrp	x21, __ZL14kpc_set_config@PAGE
	cbz	x0, LBB0_18
; %bb.1:
	mov	x19, x0
Lloh2:
...
Lloh3:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x8, __ZL16kpc_get_counting@PAGE
	str	x0, [x8, __ZL16kpc_get_counting@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.2:
Lloh4:
...
Lloh5:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x22, __ZL22kpc_force_all_ctrs_set@PAGE
	str	x0, [x22, __ZL22kpc_force_all_ctrs_set@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.3:
Lloh6:
...
Lloh7:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x23, __ZL16kpc_set_counting@PAGE
	str	x0, [x23, __ZL16kpc_set_counting@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.4:
Lloh8:
...
Lloh9:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x24, __ZL23kpc_set_thread_counting@PAGE
	str	x0, [x24, __ZL23kpc_set_thread_counting@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.5:
Lloh10:
...
Lloh11:
	...
	mov	x1, x20
	bl	_dlsym
	str	x0, [x21, __ZL14kpc_set_config@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.6:
Lloh12:
...
Lloh13:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x8, __ZL14kpc_get_config@PAGE
	str	x0, [x8, __ZL14kpc_get_config@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.7:
Lloh14:
...
Lloh15:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x8, __ZL14kpc_set_period@PAGE
	str	x0, [x8, __ZL14kpc_set_period@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.8:
Lloh16:
...
Lloh17:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x8, __ZL14kpc_get_period@PAGE
	str	x0, [x8, __ZL14kpc_get_period@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.9:
Lloh18:
...
Lloh19:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x25, __ZL21kpc_get_counter_count@PAGE
	str	x0, [x25, __ZL21kpc_get_counter_count@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.10:
Lloh20:
...
Lloh21:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x26, __ZL20kpc_get_config_count@PAGE
	str	x0, [x26, __ZL20kpc_get_config_count@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.11:
Lloh22:
...
Lloh23:
	...
	mov	x1, x20
	bl	_dlsym
	adrp	x8, __ZL16kperf_sample_get@PAGE
	str	x0, [x8, __ZL16kperf_sample_get@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.12:
Lloh24:
...
Lloh25:
	...
	str	x0, [x8, __ZL23kpc_get_thread_counters@PAGEOFF]
	cbz	x0, LBB0_17
; %bb.13:
	ldr	x8, [x25, __ZL21kpc_get_counter_count@PAGEOFF]
	mov	w0, #3
	blr	x8
	cmp	w0, #10                         ; =10
	b.ne	LBB0_30
; %bb.14:
	ldr	x8, [x26, __ZL20kpc_get_config_count@PAGEOFF]
	mov	w0, #3
	blr	x8
	cmp	w0, #8                          ; =8
	b.ne	LBB0_31
...
Lloh29:
	...
	add	x8, x8, #138                    ; =138
	str	x8, [x1, #40]
	ldr	x8, [x21, __ZL14kpc_set_config@PAGEOFF]
	mov	w0, #3
	blr	x8
	cbz	w0, LBB0_33
; %bb.16:
...
LBB0_32:
	...
	b	LBB0_20
LBB0_33:
	ldr	x8, [x22, __ZL22kpc_force_all_ctrs_set@PAGEOFF]
	mov	w0, #1
	blr	x8
	cbz	w0, LBB0_35
; %bb.34:
...
Lloh57:
	...
	b	LBB0_32
LBB0_35:
	ldr	x8, [x23, __ZL16kpc_set_counting@PAGEOFF]
	mov	w0, #3
	blr	x8
	cbz	w0, LBB0_37
; %bb.36:
...
Lloh59:
	...
	b	LBB0_32
LBB0_37:
	ldr	x8, [x24, __ZL23kpc_set_thread_counting@PAGEOFF]
	mov	w0, #3
	blr	x8
	cbz	w0, LBB0_20
; %bb.38:
...
Lloh61:
	...
	.cfi_endproc
                                        ; -- End function
	.globl	__Z12get_countersv              ; -- Begin function _Z12get_countersv
	.p2align	2
__Z12get_countersv:                     ; @_Z12get_countersv
	.cfi_startproc
; %bb.0:
...
Lloh65:
	...
	cbz	w0, LBB1_4
; %bb.1:
	adrp	x19, __ZZ12get_countersvE6warned@PAGE
	ldrb	w8, [x19, __ZZ12get_countersvE6warned@PAGEOFF]
	fmov	d8, #1.00000000
	tbnz	w8, #0, LBB1_3
; %bb.2:
Lloh66:
...
Lloh67:
	...
	bl	_puts
	mov	w8, #1
	strb	w8, [x19, __ZZ12get_countersvE6warned@PAGEOFF]
LBB1_3:
	mov.16b	v2, v8
	mov.16b	v1, v8
	mov.16b	v0, v8
...
.zerofill __DATA,__bss,__ZZ12get_countersvE6warned,1,0 ; @_ZZ12get_countersvE6warned
...
.zerofill __DATA,__bss,__ZL14kpc_set_period,8,3 ; @_ZL14kpc_set_period
l_.str.11:                              ; @.str.11
	.asciz	"kpc_get_period"

.zerofill __DATA,__bss,__ZL14kpc_get_period,8,3 ; @_ZL14kpc_get_period
l_.str.12:                              ; @.str.12
